do local GUI = game.CoreGui:FindFirstChild("MINHNHUT");if GUI then GUI:Destroy();end;if _G.Color == nil then
...
game.StarterGui:SetCore("SendNotification", {
  Title = "Minh Nhựt"; -- the title (ofc)
  Text = text; -- what the text says (ofc)
  Icon = "rbxassetid://86355800574150"; -- the image if u want.
...
function Update:Window(text,logo,keybind)
	...
	local MINHNHUT = Instance.new("ScreenGui")
	MINHNHUT.Name = "MINHNHUT"
	MINHNHUT.Parent = game.CoreGui
	MINHNHUT.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	local Main = Instance.new("Frame")
	Main.Name = "Main"
	Main.Parent = MINHNHUT
	Main.Active = true
...
Top.ZIndex = 2
	...
	Logo.Image = "rbxassetid://86355800574150"
	Logo.Active = true
	Logo.ZIndex = 8
...
Notify({
Description = "Không còn trái nào nữa";
Title = "Minh Nhựt";
Duration = 5;
});
						end
...
Shop:Button("Random Race (Use 3K Fragments)", function()
    ...
    Misc:Button("Destroy Ui",function()
        if game.CoreGui:FindFirstChild("Minh Nhựt") then
            game.CoreGui:FindFirstChild("Minh Nhựt"):Destroy()
